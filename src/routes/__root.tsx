...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "منصة توعوية لأهالي الأطفال المصابين حديثاً بالسكري من النوع الأول — محتوى مبسط، علمي، ومطمئن." },
      { property: "og:title", content: "سما — رحلة التعايش مع السكري من النوع الأول" },
      { property: "og:description", content: "منصة توعوية لأهالي الأطفال المصابين حديثاً بالسكري من النوع الأول — محتوى مبسط، علمي، ومطمئن." },

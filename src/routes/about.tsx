  ...
  head: () => ({
    meta: [
      { title: "عن المنصة والمصادر — سما" },
      {
        name: "description",
        content:
          "من نحن، وهدف منصة سما التثقيفية لأسر أطفال السكري من النوع الأول، مع المصادر الطبية المعتمدة وأرقام الطوارئ.",
      },
...
const pillars = [
  ...
  },
  {
    ...
    text: "المحتوى خضع لمراجعة طبية من مختص، ويستند إلى مراجع رسمية ودولية محدّثة.",
  },
];

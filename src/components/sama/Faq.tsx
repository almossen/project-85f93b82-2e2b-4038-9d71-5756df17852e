...
const faqs = [
  ...
  },
  {
    ...
    a: "احتمال إصابة الأخ أو الأخت أعلى قليلاً من عامة الناس، لكنه لا يعني أن الإصابة حتمية. المرض ليس معدياً وليس وراثياً بشكل مباشر. اسألوا طبيب الغدد إذا ظهرت أعراض مثل العطش الشديد، كثرة التبول، نقص الوزن، أو التعب غير المعتاد.",
  },
  {

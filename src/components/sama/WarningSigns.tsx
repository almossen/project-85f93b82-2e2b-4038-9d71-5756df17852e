...
const low = {
  title: "هبوط السكر — غالبًا أقل من ٧٠",
  ...
  action: "إذا كان الطفل واعيًا وقادرًا على البلع، اتبعوا خطة علاج الهبوط المكتوبة من الطبيب. غالبًا يكون التصرف بإعطاء مصدر سكر سريع ثم إعادة القياس بعد وقت قصير حسب الخطة.",
};

const high = {
  title: "ارتفاع السكر — فوق هدف الطفل",
  subtitle: "Hyperglycemia — يحدث تدريجياً، لكنه خطر إن أُهمل",
  signs: [
    "عطش شديد وكثرة شرب الماء",
    "كثرة التبول، وأحيانًا تبليل لا إرادي",
    "تعب وخمول غير معتاد",
    "ألم بطن أو غثيان",
    "تنفّس سريع برائحة شبيهة بالفواكه",
  ],
  action: "أعيدوا القياس إذا كانت القراءة غير متوقعة، افحصوا الكيتونات إذا كانت خطة الطبيب تطلب ذلك، ولا تعطوا جرعة تصحيح إلا وفق خطة مكتوبة من الفريق الطبي.",
};
      ...
      <div className="rounded-2xl bg-destructive/10 border border-destructive/30 p-5 flex items-start gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-muted-foreground leading-loose">
            فقدان وعي، تشنّجات، قيء متكرر، خمول شديد، صعوبة تنفّس، أو كيتونات مع مرض/قيء — اتصلوا بـ <strong className="text-destructive">٩٩٧</strong> أو اذهبوا لأقرب طوارئ مباشرة.
          </p>

...
const questions: Q[] = [
  {
    q: "السكري من النوع الأول يعني أن الجسم لا ينتج كمية كافية من ماذا؟",
  ...
  {
    q: "هل السكري من النوع الأول بسبب أكل الحلويات؟",
    options: ["نعم", "لا"],
    correct: 1,
    why: "لا. السكري من النوع الأول حالة مناعية ولا علاقة له بأكل الحلويات.",
  },
  {

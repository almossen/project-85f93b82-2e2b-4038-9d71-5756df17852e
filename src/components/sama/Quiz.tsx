...
const questions: Q[] = [
  {
    q: "ما السبب الرئيسي لإصابة الطفل بسكري النوع الأول؟",
    options: ["أكل الكثير من الحلوى", "توقّف البنكرياس عن إفراز الإنسولين", "إهمال الأهل في الرعاية"],
    correct: 1,
    why: "هو خلل مناعي يوقف خلايا البنكرياس عن إفراز الإنسولين — لا علاقة له بالطعام أو تربية الأهل.",
  },
  {
    q: "هل يستطيع طفل النوع الأول ممارسة الرياضة؟",
    options: ["لا، ممنوع تماماً", "نعم، مع متابعة قياس السكر", "فقط الرياضات الخفيفة جداً"],
    correct: 1,
    why: "الرياضة جزء أساسي من علاجه وصحته، شرط متابعة قراءات السكر وأخذ الاحتياطات.",
  },
  {
    q: "ماذا يفعل الإنسولين في الجسم؟",
    options: ["يرفع السكر في الدم", "يساعد السكر على الدخول إلى الخلايا ليصبح طاقة", "يحارب الجراثيم"],
    correct: 1,
    why: "الإنسولين هو المفتاح الذي يفتح أبواب الخلايا ليدخلها السكر فتتحوّل إلى طاقة.",
  },
];
  ...
  return (
    <section className="space-y-6">
      <header className="text-center max-w-2xl mx-auto space-y-2">
        ...
        <p className="text-muted-foreground">٣ أسئلة قصيرة — لا توجد علامات، فقط للتأكد أن المعلومة وصلت.</p>
      </header>
          ...
          <div key={i} className="rounded-2xl border border-border bg-card p-5 sm:p-6 shadow-[var(--shadow-card)]">
            ...
            {submitted && (
              <p className="mt-3 text-sm text-muted-foreground leading-loose bg-muted/50 rounded-xl p-3">
                <strong className="text-foreground">لماذا؟ </strong>
                {q.why}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              {score === questions.length
                ...
                : "لا بأس، ارجع للدرس وأعد المحاولة."}
            </p>
          </div>
          <button
            type="button"
